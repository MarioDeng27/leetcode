 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  Server\includes\tongjidemo/serviceinterface_resource_manager.h
...
#ifndef SERVER_INCLUDES_TONGJIDEMO_SERVICEINTERFACE_RESOURCE_MANAGER_H_
#define SERVER_INCLUDES_TONGJIDEMO_SERVICEINTERFACE_RESOURCE_MANAGER_H_
...
class ServiceInterfaceResourceManager final {
 public:
  ...
  /*!
   * \brief Get resource manager for service 'ServiceInterface' skeleton
   * \return Resource manager for service 'ServiceInterface' skeleton
   */
  ServiceInterfaceSkeletonResourceManager& GetSkeletonResourceManager();

 private:
  /*!
   * \brief Resource manager for service 'ServiceInterface' skeleton
   */
  ServiceInterfaceSkeletonResourceManager skeleton_resource_manager_;
};

}  // namespace resources
}  // namespace tongjidemo

#endif  // SERVER_INCLUDES_TONGJIDEMO_SERVICEINTERFACE_RESOURCE_MANAGER_H_
