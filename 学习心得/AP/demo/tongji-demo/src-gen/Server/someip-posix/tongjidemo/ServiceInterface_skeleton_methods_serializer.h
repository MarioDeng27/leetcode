 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  Server\someip-posix/tongjidemo/ServiceInterface_skeleton_methods_serializer.h
...
#ifndef SERVER_SOMEIP_POSIX_TONGJIDEMO_SERVICEINTERFACE_SKELETON_METHODS_SERIALIZER_H_
#define SERVER_SOMEIP_POSIX_TONGJIDEMO_SERVICEINTERFACE_SKELETON_METHODS_SERIALIZER_H_
 ...
 * \trace SPEC-4980140
 */
class addResponseSerializer final : public amsr::someip_protocol::internal::serialization::SomeIpSerializerBase {
 public:
   /*!
  ...
  explicit addResponseSerializer(amsr::com_common::internal::logging::AraComLogger& logger, Base::BufferPtrType packet, const Header& header)
  ...
  std::pair<Base::BufferPtrType, ::amsr::com_common::internal::serialization::SerializerStatus> Serialize(const InputStruct& input) {
    ...
    // CppImplDataTypeValue serialization for element 'result' (/AUTOSAR/StdTypes/uint32_t)
{
  ::amsr::com_common::internal::serialization::Serializer<someip_marshalling::BEPayloadNoLengthFieldPolicy, Base::RootSerializerType> serializer_result{&serializer};
  serializer_result.PushBack(input.result);
...
#endif  // SERVER_SOMEIP_POSIX_TONGJIDEMO_SERVICEINTERFACE_SKELETON_METHODS_SERIALIZER_H_
