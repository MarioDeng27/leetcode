...
#ifndef SRC_SERVER_CONFIG_LOGGING_CFG_H_
#define SRC_SERVER_CONFIG_LOGGING_CFG_H_
...
/// Context IDs
static constexpr const char kContextIdCalcServerMethodInvocator[] = "SIDS";
...
#endif  // SRC_SERVER_CONFIG_LOGGING_CFG_H_
